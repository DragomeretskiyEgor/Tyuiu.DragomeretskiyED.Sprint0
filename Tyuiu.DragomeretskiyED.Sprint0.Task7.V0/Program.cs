...
using Tyuiu.DragomeretskiyED.Sprint0.Task7.V0.Lib;
namespace Tyuiu.DragomeretskiyED.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Драгомерецкий Е. Д. | СМАРТб-23-1";
            //Длинна строка 75 символов
            Console.WriteLine("***************************************************************************");
