...
namespace Tyuiu.DragomeretskiyED.Sprint0.Task6.V0.Lib
{
    public class DataService
    {
        ...
        //Пример циклической структуры (цико с предусловием) while
        ...
        //Пример циклической структуры (цикл с постусловием) while
